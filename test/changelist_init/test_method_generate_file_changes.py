...
def test_generate_file_changes_tracked_only_given_single_untracked_returns_empty_list(
...
def test_generate_file_changes_tracked_only_given_multi_init_this_returns_file_changes(
